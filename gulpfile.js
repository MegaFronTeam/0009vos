    ...
    return src(`${sourse}/img/*.{png,jpg,jpeg,webp,raw}`)
        .pipe(sharpResponsive({
            formats: [
                ...
                { format: "webp", webpOptions: { quality: 90, progressive: true }, rename: { dirname: `${path2}webp/` } },
                { format: "avif", avifOptions: { quality: 90, progressive: true }, rename: { dirname: `${path2}avif/` } },
                ...
                {width: w50, webpOptions: { quality: 90, progressive: true }, format: "webp", rename: { dirname: `${path1}webp/` } },
                { width: w50, avifOptions: { quality: 90, progressive: true }, format: "avif", rename: { dirname: `${path1}avif/` } },
